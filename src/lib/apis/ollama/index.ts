...
export const generateChatCompletion = (token: string = '', body: object) => new Promise<[Response, AbortController]>(async (resolve, reject) => {
	let controller = new AbortController();

	fetch(`${OLLAMA_API_BASE_URL}/api/chat`, {
...
export const generateChatCompletion_old = async (token: string = '', body: object) => {
	let controller = new AbortController();
	let error = null;
